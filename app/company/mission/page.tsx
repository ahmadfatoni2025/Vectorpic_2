        ...
        <div className="w-full max-w-5xl">
          <div className="flex justify-center gap-8 mb-16">
            <button
              ...
              className={`text-sm font-black uppercase tracking-widest pb-4 border-b-4 transition-all ${activeTab === 'vision' ? "border-blue-600 text-black translate-y-[-4px]" : "border-transparent text-gray-300 hover:text-black"
                }`}
            >
              Our Vision
            </button>
            <button
              ...
              className={`text-sm font-black uppercase tracking-widest pb-4 border-b-4 transition-all ${activeTab === 'mission' ? "border-blue-600 text-black translate-y-[-4px]" : "border-transparent text-gray-300 hover:text-black"
                }`}
            >
              Our Mission
            </button>
