...
export default function MotionGraphics() {
  ...
  useEffect(() => {
    fetch('/api/track-tabs')
      .then(r => r.json())
      .then(data => {
        const tab = (Array.isArray(data) ? data : []).find((t: any) => t.tabId === 'motion');
      ...
      <div className="max-w-7xl mx-auto flex flex-col pt-32">
                    ...
                    <div className="flex -space-x-2">
                       {[7,8,9].map(i => (
                         <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-gray-200 overflow-hidden relative">
                           <Image src={`https://i.pravatar.cc/150?u=motion-${i}`} alt="user" fill className="object-cover" />
                         </div>
                       ))}
                    </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 md:gap-6 mb-20">
          ...
          <div className="lg:col-span-4 aspect-[4/5] md:aspect-auto md:h-[500px] rounded-[2rem] bg-gray-100 overflow-hidden relative group">
              <Image src={d.card1Image} alt="Motion Graphics" fill className="object-cover" unoptimized />
                ...
                <div className="flex justify-between items-start">
                   <div className="flex items-center gap-2">
                      <div className="w-6 h-6 border-2 border-white/20 rounded-md flex items-center justify-center p-1">
                          <div className="w-full h-full bg-white rounded-full opacity-50"></div>
                      </div>
          ...
          <div className="lg:col-span-3 aspect-square lg:aspect-auto lg:h-[500px] rounded-[2rem] bg-gray-50 overflow-hidden relative group">
              <Image src={d.card3Image} alt="Physics" fill className="object-cover" unoptimized />
          ...
          <div className="lg:col-span-2 aspect-[3/4] lg:aspect-auto lg:h-[500px] rounded-[2rem] bg-gray-100 overflow-hidden relative group">
              <Image src={d.card4Image} alt="Dynamic Arts" fill className="object-cover" unoptimized />
              <div className="absolute bottom-8 left-8">
